...
public class TelaCadastroClienteAdmin extends javax.swing.JFrame {
    ...
    private void BtnAtualizarClienteActionPerformed(java.awt.event.ActionEvent evt) {                                                    
    	String nome = TxtNome.getText();
		String cpf = TxtCpf.getText();
		String rua = TxtRua.getText();
		String bairro = TxtBairro.getText();
    ...
    private void BtnDeletarClienteActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    	String cpf = TxtCpf.getText();
