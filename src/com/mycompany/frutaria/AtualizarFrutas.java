 ...
 * @author victor
 */
public class AtualizarFrutas extends JFrame {
	...
	private void initComponents() {
		...
		HeaderCadastrarFrutas.setText("ATUALIZAR FRUTAS");
...
//        int estoque = Integer.parseInt(TxtEstoque.getText());
	...
	public static void main(String args[]) {
		...
		try {
			...
			Logger.getLogger(AtualizarFrutas.class.getName()).log(Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new AtualizarFrutas().setVisible(true);
			}
		});
	}
